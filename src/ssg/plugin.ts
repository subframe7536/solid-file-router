...
import type { RouteRegistry } from '../routes/registry'
...
import type { BundleOutput, EnvironmentName, PrerenderRoutesSource } from './index'
...
export function createSsgConfigPlugin<TData>(
  options: SsgOptions,
...
export function createSsgEntryPlugin(): Plugin {
  return {
...
export function createSsgRenderPlugin<TData>(
  options: SsgOptions,
